...
\begin{frame}
  ...
  \scriptsize
  \begin{itemize}
    \item Generative models such as Naive Bayes can be used for sequence labeling tasks in NLP.
    \item Approach:
    \begin{itemize}\scriptsize
...
\begin{frame}
  ...
  \scriptsize
  \begin{itemize}
    \item  HMMs provide a principled way to handle sequence labeling problems using generative modeling and efficient decoding algorithms.
