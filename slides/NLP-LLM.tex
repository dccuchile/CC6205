...
\begin{scriptsize}
\begin{itemize}
\item GPT-3 showcased remarkable capabilities in NLP tasks through different learning paradigms: zero-shot, one-shot, and few-shot learning.
...
\item \textbf{Few-shot learning}: providing a limited number input-outpur pairs after the instruction in the prompt.
\end{itemize}
\end{scriptsize}
\end{frame}
