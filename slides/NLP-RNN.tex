...
\item An alternative approach to the transducer for sequence labeling is to combine the RNN with Conditional Random Fields (CRFs).
\item This produces a powerful tagger \cite{huang2015bidirectional}, in which the RNN acts as feature extractor, and the CRF as a special layer.
