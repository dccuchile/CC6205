...
\begin{equation}
\vec{h}_{[j]}^l = \sum_{i}  \left( W_{[i,j]}^l \times \vec{z}_{[i]}^{(l-1)} + \vec{b}_{[j]}^l \right)
\label{eq:sum}
\end{equation}
...
\begin{displaymath}
\vec{h}_{[k]}^{(l+1)} = \sum_{i} \left(W_{[i,k]}^{l+1} \times \vec{z}_{[i]}^{l} + \vec{b}_{[k]}^{(l+1)}\right) 
\end{displaymath}
...
\begin{displaymath}
\vec{h}_{[k]}^{(l+1)} = \sum_{i}  \left( W_{[i,k]}^{l+1} \times g(\vec{h}_{[i]}^{l}) + \vec{b}_{[k]}^{(l+1)}\right) 
\end{displaymath}
