...
A continuación desarrollamos de forma más concreta el uso de aprendizaje automático para tareas de PLN.
...
En este capítulo, hemos explorado el desafío de comprender y producir lenguaje utilizando la computación. El aprendizaje automático supervisado se ha destacado como una de las principales técnicas utilizadas para abordar este desafío. Además, hemos discutido las propiedades desafiantes del lenguaje. Finalmente, hemos visto cómo el aprendizaje profundo ha demostrado mejoras significativas en el rendimiento de los modelos de PLN. Estos modelos, como las redes neuronales, han logrado superar barreras anteriores al poder capturar patrones más complejos y aprender representaciones más ricas del lenguaje.

Sin embargo, también discutido las limitaciones y desafíos que enfrenta el PLN. La anotación de datos, la generalización a nuevos dominios y la evolución del lenguaje son solo algunos de los aspectos que requieren una atención cuidadosa. Además, la preocupación por los sesgos y prejuicios presentes en los datos y en los modelos es una consideración crítica para garantizar la equidad y la ética en la aplicación de PLN.
