...
\begin{frame}\frametitle{Representación Vectorial de Texto (2/2)}
  \begin{itemize}
   ...
   \item A continuación veremos una forma clásica para representar palabras como vectores llamada \emph{Bag of Words} y una variación para ponderar las representaciones llamada \emph{TF-IDF}.
\end{itemize}
\end{frame}
...
\hline
Frecuencia Bruta & $tf_{i,j} = f_{i,j}$ \\
\hline
